...
to go
  ...
  ask turtles [
    ...
    if (color = violet) [
      if count turtles with [color = violet] > hospital-capacity
      [
        set color gray
        set speed 0
        set hours 0
...
"" ""
PENS
"Free beds" 1.0 0 -16777216 true "" "plot hospital-capacity - count turtles with [color = violet]"
